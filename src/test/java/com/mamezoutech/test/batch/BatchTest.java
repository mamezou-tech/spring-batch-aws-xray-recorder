...
import com.mamezoutech.springbatch.XRayConfiguration;
...
@SpringBatchTest
@ContextConfiguration(classes = {XRayConfiguration.class, XRayRecorderJobListenerConfiguration.class, TestConfiguration.class})
